...
C
C/6S
       IF(N.LT.1) CALL SETERR(12H GEFS-N.LT.1,12,1,2)
       IF (IA.LT.N) CALL SETERR(13H GEFS-IA.LT.N,13,2,2)
       IF(IB.LT.N) CALL SETERR(13H GEFS-IB.LT.N,13,3,2)
       IF(NB.LT.1) CALL SETERR(13H GEFS-NB.LT.1,13,4,2)
C/7S
C      IF(N.LT.1) CALL SETERR(' GEFS-N.LT.1',12,1,2)
C      IF (IA.LT.N) CALL SETERR(' GEFS-IA.LT.N',13,2,2)
C      IF(IB.LT.N) CALL SETERR(' GEFS-IB.LT.N',13,3,2)
C      IF(NB.LT.1) CALL SETERR(' GEFS-NB.LT.1',13,4,2)
C/
C FORWARD SOLVE
       IF (N.EQ.1) RETURN
       NM1=N-1
...
C/6S
          CALL SETERR(22H GEFS-INTER NOT IN 1-N,22,5,2)
C/7S
C         CALL SETERR(' GEFS-INTER NOT IN 1-N',22,5,2)
C/
          RETURN
 10      CONTINUE
         DO 35 I=1,NB
