...
C
C/6S
        IF(N.LT.1)CALL SETERR(12HDGELU-N.LT.1,12,1,2)
        IF(IA.LT.N)CALL SETERR(13HDGELU-IA.LT.N,13,2,2)
C/7S
C       IF(N.LT.1)CALL SETERR('DGELU-N.LT.1',12,1,2)
C       IF(IA.LT.N)CALL SETERR('DGELU-IA.LT.N',13,2,2)
C/
        CALL ENTER(1)
        IERR=0
        INTER(N)=1
...
C/6S
           IF (IERR.EQ.0)
     1        CALL SETERR(21HDGELU-SINGULAR MATRIX,21,9+K,1)
C/7S
C          IF (IERR.EQ.0)
C    1        CALL SETERR('DGELU-SINGULAR MATRIX',21,9+K,1)
C/
              IERR=1
...
C/6S
        IF (IERR.EQ.0)
     1        CALL SETERR(21HDGELU-SINGULAR MATRIX, 21, 9+N, 1)
C/7S
C       IF (IERR.EQ.0)
C    1        CALL SETERR('DGELU-SINGULAR MATRIX', 21, 9+N, 1)
C/
