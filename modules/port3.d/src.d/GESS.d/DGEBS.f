...
C/6S
       IF (N.LT.1) CALL SETERR(12HDGEBS-N.LT.1,12,1,2)
       IF (IA.LT.N) CALL SETERR(13HDGEBS-IA.LT.N,13,2,2)
       IF (IB.LT.N) CALL SETERR(13HDGEBS-IB.LT.N,13,3,2)
       IF (NB.LT.1) CALL SETERR(13HDGEBS-NB.LT.1,13,4,2)
C/7S
C      IF (N.LT.1) CALL SETERR('DGEBS-N.LT.1',12,1,2)
C      IF (IA.LT.N) CALL SETERR('DGEBS-IA.LT.N',13,2,2)
C      IF (IB.LT.N) CALL SETERR('DGEBS-IB.LT.N',13,3,2)
C      IF (NB.LT.1) CALL SETERR('DGEBS-NB.LT.1',13,4,2)
C/
        CALL ENTER(1)
C DO THE BACK SOLVE
 50    NP1=N+1
...
C/6S
          CALL SETERR(38HDGEBS-DIVISION BY ZERO-SINGULAR MATRIX,
     1    38,9+K,1)
C/7S
C         CALL SETERR('DGEBS-DIVISION BY ZERO-SINGULAR MATRIX',
C    1    38,9+K,1)
C/
          GO TO 75
 60       B(K,I)=T/A(K,K)
