...
C/7S
C     CHARACTER*1  IFMT1(20), IFMT2(19), BLANK, STAR, TCHAR, FCHAR
C     CHARACTER*20 IFMT1C
C     CHARACTER*19 IFMT2C
C     EQUIVALENCE (IFMT1(1), IFMT1C), (IFMT2(1), IFMT2C)
C     CHARACTER*1  LINE(40), LAST(40)
C/
...
C/7S
C     DATA BLANK/' '/, STAR/'*'/, TCHAR/'T'/, FCHAR/'F'/, INDW/7/
C/
C
C
...
C     DATA IFMT1( 9) /'2'/,  IFMT2( 9) /' '/
C     DATA IFMT1(10) /'A'/,  IFMT2(10) /' '/
C     DATA IFMT1(11) /'1'/,  IFMT2(11) /'('/
C     DATA IFMT1(12) /','/,  IFMT2(12) /'3'/
C     DATA IFMT1(13) /' '/,  IFMT2(13) /'X'/
C     DATA IFMT1(14) /'2'/,  IFMT2(14) /','/
C     DATA IFMT1(15) /'X'/,  IFMT2(15) /'1'/
C     DATA IFMT1(16) /','/,  IFMT2(16) /'A'/
C     DATA IFMT1(17) /'2'/,  IFMT2(17) /'1'/
C     DATA IFMT1(18) /'A'/,  IFMT2(18) /')'/
C     DATA IFMT1(19) /'1'/,  IFMT2(19) /')'/
C     DATA IFMT1(20) /')'/
C/
C
C
